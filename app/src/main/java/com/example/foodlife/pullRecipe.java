...
import com.example.foodlife.adapters.IngredientListAdapter;
...
public class pullRecipe extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newRecipe.setImageResource(R.drawable.ic_plus_white_36dp);
        newRecipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Added to Personal Cookbook!", Toast.LENGTH_SHORT).show();

...
import com.example.foodlife.adapters.RecipeListAdapter;
...
public class RecipeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pantryIngredients = getIntent().getStringArrayListExtra("PANTRY");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (item.getItemId()) {
            ...
            case R.id.suggestions_button:
                Toast.makeText(this, "Tap Item to DELETE", Toast.LENGTH_SHORT)
                        .show();
